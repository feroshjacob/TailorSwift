...
public class WebScaldingLaunchTab extends AbstractLaunchConfigurationTab {
	...
	private Text text;
	private Table tblprogramOptions;
	private Table tblprogramArguments;
	...
	public void createControl(Composite parent) {
		...
		Button btnAddOption = new Button(comp, SWT.NONE);
		btnAddOption.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
	...
	//	addTable(comp, tblprogramArguments);
		
		Button btnAddArgument = new Button(comp, SWT.NONE);
		btnAddArgument.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false, false, 1, 1));
		btnAddArgument.setText("Add argument");
		setControl(comp);
	}
	...
	protected void addTable(Composite comp) {
