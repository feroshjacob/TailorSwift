   ...
   public class JavaLaunchConfigurationUtils {
           ...
           public static IType getMainType(String mainTypeName, IJavaProject javaProject) throws CoreException {
                   if ((mainTypeName == null) || (mainTypeName.trim().length() < 1)) {
                           abort("Main_type_not_specified_3", null, IJavaLaunchConfigurationConstants.ERR_UNSPECIFIED_MAIN_TYPE); //$NON-NLS-1$
                   }
                   IType mainType = null;
                   try {
                   ...
                   if (mainType == null) {
                           abort("Main_type_does_not_exist_4", null, IJavaLaunchConfigurationConstants.ERR_UNSPECIFIED_MAIN_TYPE); //$NON-NLS-1$
                   }
                   return mainType;
           }       
