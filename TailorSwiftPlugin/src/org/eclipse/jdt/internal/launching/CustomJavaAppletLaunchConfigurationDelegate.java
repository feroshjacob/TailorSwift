...
public class CustomJavaAppletLaunchConfigurationDelegate extends
		...
		JavaLaunchDelegate implements MavenLaunchConstants {
	  ...
	  public void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor)
	    ...
	    try {
	      ...
	      workingCopy.setAttribute(MavenLaunchConstants.ATTR_POM_DIR, "/home/ferosh/workspaces/runtime-EclipseApplication/Hola");
	      workingCopy.setAttribute(MavenLaunchConstants.ATTR_GOALS, "clean package");
...
//	      log.info(" mvn" + getProgramArguments(configuration)); //$NON-NLS-1$
	...
	//return new File("/home/ferosh/workspaces/runtime-EclipseApplication/Hola");
	  ...
	  protected String getGoals(ILaunchConfiguration configuration) throws CoreException {
	    return configuration.getAttribute(MavenLaunchConstants.ATTR_GOALS, "clean install"); //$NON-NLS-1$
	  }
